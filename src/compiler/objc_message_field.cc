...
namespace google { namespace protobuf { namespace compiler { namespace objectivec {
  ...
  void MessageFieldGenerator::GenerateBuilderMembersSource(io::Printer* printer) const {
    printer->Print(variables_,
      ...
      "}\n"
      "- ($classname$_Builder*) merge$capitalized_name$:($storage_type$) value {\n"
      "  if (_builderResult.has$capitalized_name$ &&\n"
      "      _builderResult.$name$ != [$type$ defaultInstance]) {\n"
      "    _builderResult.$name$ =\n"
      "      [[[$type$ builderWithPrototype:_builderResult.$name$] mergeFrom:value] buildPartial];\n"
      "  } else {\n"
      "    _builderResult.$name$ = value;\n"
      "  }\n"
      "  _builderResult.has$capitalized_name$ = YES;\n"
  ...
  void RepeatedMessageFieldGenerator::GenerateBuilderMembersSource(io::Printer* printer) const {
    printer->Print(variables_,
      ...
      "    _builderResult.$list_name$ = [PBAppendableArray arrayWithValueType:PBArrayValueTypeObject];\n"
      "  }\n"
      "  [_builderResult.$list_name$ addObject:value];\n"
      "  return self;\n"
      "}\n"
      "- ($classname$_Builder *)set$capitalized_name$Array:(NSArray *)array {\n"
      "  _builderResult.$list_name$ = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeObject];\n"
      "  return self;\n"
      "}\n"
      "- ($classname$_Builder *)set$capitalized_name$Values:(const $storage_type$ *)values count:(NSUInteger)count {\n"
      "  _builderResult.$list_name$ = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeObject];\n"
      "  return self;\n"
      "}\n"
      "- ($classname$_Builder *)clear$capitalized_name$ {\n"
